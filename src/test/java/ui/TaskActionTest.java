...
//        loginPage.login(new User("admin","admin"));
    ...
    public void createTaskTest(String taskName) {
        ...
        BoardPage boardPage = mainPage.chooseProjectByIndex(1);
        boardPage.addNewTask();

        TaskForm taskForm = TaskForm.newBuilder(driver, taskName)
    ...
    public void addCommentTaskTest(String comment){
        mainPage = new MainPage(driver);
        TaskPage taskPage = mainPage.chooseLastCreatedTask().addComment(comment);
